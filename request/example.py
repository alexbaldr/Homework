...
def translate_it(text, translate, from_lang, to_lang):
    """
    ...
    json_ = response.json()
    #print(json_)
    with open (translate, "w", encoding="utf-8") as fo:
        fo.write(''.join(json_['text']))    
...
if __name__ == '__main__':
    ...
    translate_it("DE.txt","DEinRUS.txt",'de',"ru")
    translate_it("ES.txt", "ESinRUS.txt",'es',"ru")
    translate_it("FR.txt", "FRinRUS.txt",'fr',"ru")
